...
const HeroText = () => {
  return (
    ...
    >
      <motion.h1 className="text-white text-3xl font-bold"
      ...
      <motion.div className="space-x-5"
       ...
       transition={{ delay: 0.7, stiffness: 50, type: "spring" }}>
        <input
          ...
          className="bg-white rounded-full p-4 w-[450px]"
        />
        <button
          value=""
          className="bg-[#005555] rounded-full w-28 p-4 text-white placeholder:text-white"
        >
          Search
        </button>
      </motion.div>
